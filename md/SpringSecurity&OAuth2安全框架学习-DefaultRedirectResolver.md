````text
DefaultRedirectResolver为默认的redirect_uri映射解析器，具体处理方法在obtainMatchingRedirect方法之中.
AuthorizationEndpoint使用DefaultRedirectResolver来映射redirect_uri
````
```java
